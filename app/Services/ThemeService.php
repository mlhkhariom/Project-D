...
{
    /**
     * Hardcoded static array of 20 themes to avoid procedural generation overhead during instantiation.
     * Prevents expensive operations and random function calls on every view render.
     */
