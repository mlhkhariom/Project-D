...
{
    /**
     * ⚡ Bolt Optimization: Procedural generation removed.
     * What: Replaced a constructor loop and array_rand() with a statically hardcoded array.
     * Why: This service is injected into all views via View::composer('*'), meaning it instantiated
     *      frequently. Procedurally generating 18 themes via array_rand() created CPU overhead
     *      and led to non-deterministic behavior (fonts randomly changing across requests).
     * Impact: Eliminates O(N) generation logic on instantiation. PHP OPcache can now store the array
     *         in shared memory, resulting in zero-overhead instantiation.
     */
