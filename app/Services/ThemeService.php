...
class ThemeService
{
    // Hardcoded static array of themes to eliminate initialization overhead
    // and prevent non-deterministic font selection caused by array_rand()
    // during procedural generation. This ensures deterministic behavior and allows
    // PHP OPcache to store the array in shared memory.
