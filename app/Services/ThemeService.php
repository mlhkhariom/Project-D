...
class ThemeService
{
    ...
    {
        // ⚡ Bolt Optimization: Removed generateProceduralThemes() from constructor.
        // Procedurally generating static deterministic data in the constructor of a
        // globally injected singleton causes massive overhead. Hardcoding the output
        // into a static array drastically reduces initialization time and memory usage
        // and solves hidden bugs related to non-deterministic behavior (array_rand).
    }
