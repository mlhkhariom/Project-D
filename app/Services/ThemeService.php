...
{
    /**
     * Static array of themes. Hardcoded to optimize performance
     * by eliminating procedural generation overhead during instantiation
     * and allowing OPCache to store the array in shared memory.
     */
