...
class ThemeService
{
    ...
    {
        // Procedural themes are now lazy-loaded to prevent overhead on every request
    }
    ...
    public function getActiveThemeConfig(): array
    {
        ...
        // Lazy load procedural themes if the active theme is not one of the default themes
