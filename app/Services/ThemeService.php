...
{
    /**
     * Hardcoded static array of themes.
     * Optimization: Replaced procedural generation in the constructor with a static array.
     * This eliminates initialization overhead (zero-overhead instantiation) as PHP OPcache
     * can store this directly in shared memory. This is critical because this service is
     * a singleton globally injected via View::composer("*"), running once per request.
     */
