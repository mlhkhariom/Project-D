...
{
    /**
     * Hardcoded static array of themes to avoid procedural generation overhead.
     * This provides zero-overhead instantiation and deterministic font selection,
     * which is critical because this service is injected globally via View::composer('*').
     */
