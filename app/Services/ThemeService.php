...
{
    /**
     * Pre-computed theme configurations.
     *
     * OPTIMIZATION: Previously, 18 of these themes were generated procedurally in the constructor.
     * Since this service is instantiated on every request (via View::composer('*')),
     * the loop added unnecessary overhead and non-deterministic behavior (array_rand for fonts).
     * By hardcoding them, PHP OPcache can store the array in shared memory, achieving ~O(1) initialization.
     */
