...
class ThemeService
{
     ...
     * Hardcoded static array instead of procedural generation in constructor.
     * This allows PHP OPcache to store the array in shared memory, eliminating
     * runtime initialization overhead (up to ~150x reduction in instantiation time)
     * and ensuring deterministic font selection.
     */
